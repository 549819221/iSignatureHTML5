var $jscomp={scope:{},findInternal:function(d,f,g){d instanceof String&&(d=String(d));for(var m=d.length,n=0;n<m;n++){var h=d[n];if(f.call(g,h,n,d))return{i:n,v:h}}return{i:-1,v:void 0}}};$jscomp.defineProperty="function"==typeof Object.defineProperties?Object.defineProperty:function(d,f,g){if(g.get||g.set)throw new TypeError("ES3 does not support getters and setters.");d!=Array.prototype&&d!=Object.prototype&&(d[f]=g.value)};
...
return(b=document.cookie.match(new RegExp("(^| )"+a+"=([^;]*)(;|$)")))?unescape(b[2]):null}function n(a){var b=new Date;b.setTime(b.getTime()-1);var c=m(a);null!=c&&(document.cookie=a+"="+c+";expires="+b.toGMTString())}d=window.kinggrid;var h=window.Signature,q=window.jQuery;"use strict";var r=function(a,b){this.preV={x:null,y:null};this.pinchStartLen=null;this.scale=1;this.isDoubleTap=!1;this.rotate=b.rotate||function(){};this.pointStart=b.pointStart||function(){};this.multipointStart=b.multipointStart||
...
b.errcode?a.warning(b):a.warning("\u7b7e\u540d\u6570\u636e\u88ab\u7be1\u6539")})};if(c=b.find("#sign_"+a.signatureid)[0])c.onclick=function(){a.signSignature(function(c){c.result&&(a.warning("\u6570\u5b57\u7b7e\u540d\u6210\u529f\uff01"),b.remove())})};if(null==a.icon_remove||1==a.icon_remove)b.find("#revoke_"+a.signatureid)[0].onclick=function(){a.revokeSignature(function(a){a.result&&b.remove()})}}})};h.prototype.handWriteDlg=function(a,b){if(a.width&&a.height){var c=h.options.template.handwritedlg,
e=c.substring(0,c.indexOf("width=")+6),d=c.substring(c.indexOf("px "),c.length),e=e+a.width,e=e+d,c=e.substring(0,e.indexOf("height=")+7),d=e.substring(e.indexOf("px>"),e.length),c=c+a.height;h.options.template.handwritedlg=c+d}var k=this.showDialog("handwritedlg",a),c=document.getElementById("canvasId");a.penColor=document.getElementById("hw_color").value;a.minWidth=.5;a.maxWidth=4.5;var l=new SignaturePad(c,a),f=document.getElementById("hw_color");f.onchange=function(){l.penColor=f.value};var g=
document.getElementById("hw_width");g.onchange=function(){switch(g.value){case "1":l.minWidth=.5;l.maxWidth=2.5;break;case "2":l.minWidth=.5;l.maxWidth=4.5;break;case "3":l.minWidth=1;l.maxWidth=6;break;case "4":l.minWidth=1;l.maxWidth=8;break;case "5":l.minWidth=2.5;l.maxWidth=10;break;case "6":l.minWidth=3;l.maxWidth=12;break;default:l.minWidth=.5,l.maxWidth=2.5}};c=document.getElementById("clearid");e=document.getElementById("okid");c&&(c.onclick=function(){l.clear()});e&&(e.onclick=function(){k.close();
var c=l.toDataURL().replace(/^data:image\/\w+;base64,/,"");c&&(c={height:a.image_height||"3.00",width:a.image_width||"7.00",imageData:c,name:document.getElementById("nameid").value},b(c))})};h.prototype.barCodeDlg=function(a,b){var c=this.showDialog("barcodedlg",{title:"\u4e8c\u7ef4\u7801",target:this,onCancel:!1}),e=document.getElementById("bc_clearid"),d=document.getElementById("bc_okid"),k=document.getElementById("bcId");e&&(e.onclick=function(){k.value=""});d&&(d.onclick=function(){c.close();
var d=q("#output").qrcode(k.value);b({height:a.image_height||"5",width:a.image_width||"5",imageData:d,name:"\u4e8c\u7ef4\u7801"})})};h.prototype.scanBCDlg=function(a,b){var c=this.showDialog("scanbarcodedlg",{title:"\u626b\u7801\u7b7e\u7ae0",target:this,onCancel:!1});try{var d=document.getElementById("qr-canvas").getContext("2d"),f=document.getElementById("html5_qrcode_video");navigator.getUserMedia=navigator.getUserMedia||navigator.webkitGetUserMedia||navigator.mozGetUserMedia||navigator.msGetUserMedia;
window.URL=window.URL||window.webkitURL||window.mozURL||window.msURL;navigator.getUserMedia&&navigator.getUserMedia({video:!0,audio:!1},function(a){f.src=window.URL.createObjectURL(a);f.play()},function(a){alert("\u51fa\u9519\u4fe1\u606f: "+err.name)});var k=setInterval(function(){if(d){d.drawImage(f,0,0,640,480);var e=d.getImageData(0,0,640,480);if(e=jsQR.decodeQRFromImage(e.data,e.width,e.height))c.close(),window.clearInterval(k),a.content=e,e={height:a.image_height||"5",width:a.image_width||"5",
imageData:q("#output").qrcode(e),name:"\u4e8c\u7ef4\u7801"},b(e)}},2E3)}catch(l){printHtml("\u6d4f\u89c8\u5668\u4e0d\u652f\u6301HTML5 CANVAS")}};h.prototype.onshowSealsDialog_PW=function(a){var b=this.keysn||this.keyData.keysn;"true"==m("ck")&&a.find("#kg-remenberPwd").attr("checked","checked");if(a.find("#kg-remenberPwd").is(":checked")){var c=m("ksn");b==c&&(a=a.find("#kg-password"),b=m("pwd"),null!=b?a.val(b):a.val("123"))}};h.prototype.onexecSuccess=function(a,b,c){var d=this.keysn||this.keyData.keysn;
if(c){var f=m("ksn");a=h.options.pw_timeout;c=function(a){if(d!=f){if("undefined"==typeof a||0>a.indexOf("s")&&0>a.indexOf("h")&&0>a.indexOf("d"))a="s1800";h.options.pw_enc_save&&(b=p.Base64.of().encode(b));g("ksn",d,a);g("pwd",b,a);g("ck","true",a)}};h.options.pw_server_timeout?this.sealService.getPwdSaveTime(c,a):c(a)}else n("ksn"),n("pwd"),n("ck")};d=kingPlus();p.extend(d.alertConfig,{cancelDisplay:!0,quickClose:!1,backdropOpacity:.1});p.extend(d.loadingConfig,{cancelDisplay:!0,quickClose:!1,backdropOpacity:.1});
p.extend(d.dialogConfig,{cancelDisplay:!1,quickClose:!0});return h});
// V1.0.0.322    
